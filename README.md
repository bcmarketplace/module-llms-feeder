...
The renderer will automatically serve the appropriate store-specific content based on the request context. See the [Server Configuration](#-server-configuration) section for setup instructions.
